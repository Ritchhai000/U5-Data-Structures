...
public class Precipitation {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for(int i = 0; i < month.length; i++){
            ...
            output.printf("The average rainfall in " + month[i] + " over the last 20 years: %.2f%n", rainfallPerYear[i]);
        }

        output.printf("The average monthly rainfall over the last 20 years is %.2f%n", calc.avg(rainfallPerMonth));
